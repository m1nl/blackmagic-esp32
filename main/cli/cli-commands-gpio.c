...
static const GPIOItem gpio_items[] = {
    ...
    // UART
    MAKE_IO(1),
    MAKE_IO_NAMED("CLI_TXD", 1),
    MAKE_IO(2),
    MAKE_IO(3),
    MAKE_IO_NAMED("CLI_RXD", 3),
    // I2C_PULL_UP
    ...
    // SPI
    MAKE_IO(12),
    MAKE_IO_NAMED("SPI_MISO", 12),
    MAKE_IO(13),
    MAKE_IO_NAMED("SPI_MOSI", 13),
    MAKE_IO(14),
    MAKE_IO_NAMED("SPI_CLK", 14),
    MAKE_IO(15),
    MAKE_IO_NAMED("SPI_CS", 15),
    // GPIO
    MAKE_IO(16),
    MAKE_IO(17),
    MAKE_IO(18),
    ...
    // SWD
    MAKE_IO(25),
    MAKE_IO_NAMED("SWCLK", 25),
    MAKE_IO(26),
    MAKE_IO_NAMED("SWDIO", 26),
    // GPIO
    MAKE_IO(27),
    MAKE_IO(32),
    MAKE_IO(33),
